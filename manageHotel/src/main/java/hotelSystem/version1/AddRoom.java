...
public class AddRoom extends JFrame implements ActionListener {
    ...
    public AddRoom() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotelSystem\\version1\\icons\\twelve.jpg"));
        ...
        JLabel l6 = new JLabel("Gallery Type");
        l6.setForeground(new Color(25, 25, 112));
        l6.setFont(new Font("Tahoma", Font.BOLD, 14));
        l6.setBounds(64, 270, 102, 22);
        contentPane.add(l6);
        
        comboBox_4 = new JComboBox(new String[] { "Open", "Closed" });
        comboBox_4.setBounds(176, 270, 154, 20);
        ...
        try {
            ...
            if (ae.getSource() == b1) {
                try {
                    ...
                    String gtype = (String) comboBox_4.getSelectedItem();
