...
public class Room extends JFrame {
    ...
    public Room() throws SQLException {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotelSystem\\version1\\icons\\eight.jpg"));
        ...
        gallery_type = new JLabel("Gallery Type");
        gallery_type.setBounds(435, 15, 76, 14);
        contentPane.add(gallery_type);
